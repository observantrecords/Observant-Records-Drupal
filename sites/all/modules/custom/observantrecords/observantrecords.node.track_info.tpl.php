	...
	<tbody>
		...
		<tr>
			...
			<td class="play-column">
				...
				<a href="#" id="button-<?php echo $track['track_recording_id']; ?>" class="play-button"><img src="<?php echo emptyensemble_get_vigilante_uri(); ?>/images/icons/speaker-grey.gif" alt="[Play]" title="[Play]" /></a>
				<?php endif; ?>
			</td>
		</tr>
		<?php endforeach; ?>
